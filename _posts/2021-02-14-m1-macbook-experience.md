...
{% include image.html link="img/in-post/post-macbook/idlefish.jpg" alt="Thinkbook Sold" wrapper_class="float-md-end" %}
...
{% include image.html link="img/in-post/post-macbook/in-store.jpg" alt="New MacBook"%}
...
{% include image.html link="img/in-post/post-macbook/old-laptops.png" alt="Thinkbook 14 Gen 2 & U3000UQ"%}
...
听说蝴蝶键盘经过多年的迭代也仅仅是勉强可用。

事实上，中上乘。MacBook的蝴蝶键盘打破了我的惟键程论，虽然键程相较Thinkbook确实短一些，但回弹力度足够，凹陷的键帽更加贴合手指，打字还是比较舒服的。摸过老婆覆了膜的MacBook键盘，加上了TPU键盘膜确实回弹体验稍差，一时间不知道是不是该裸奔下去。

除了回弹，键盘背光非常温柔。每一颗键帽单独的LED确实让键盘的背光更加均匀，更有安全感。

{% include image.html link="img/in-post/post-macbook/keys.jpg" alt="Keyboard Backlight"%}
...
{% include image.html link="/img/in-post/post-macbook/unsleep.png" alt="拿到电脑后" wrapper_class="d-inline-block" %}
