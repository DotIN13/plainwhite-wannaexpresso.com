...
{% include image.html link="in-post/post-modem-bridge/raspberrypi.jpg" alt="RaspberryPi 4B" %}
...
{% include image.html link="in-post/post-modem-bridge/modem.png" alt="ONT Settings" %}
